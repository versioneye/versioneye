...
* <b>URLs</b>: Alowing now dots in rails params

== 1.1.0

* <b>GitHub View</b>: We developed a single page application for dealing with GitHub Repositories. Watch the movie here.
* <b>Branches</b>: You can now even select which branch you want to monitor!
* <b>Password Reset</b>: We changed the password reset process. We don't send out clear text passwords anymore!
* <b>PHP dev-master</b>: dev-master is not countet as newest if there are other ones.

...
describe Product do
  ...
  describe "newest_version_number" do
    ...
    it 'delivers dev' do
      ...
      version = product.newest_version_number( VersionTagRecognizer::A_STABILITY_DEV )
      version.should eql("2.0.7")
      version = product.newest_version_number( VersionTagRecognizer::A_STABILITY_ALPHA )
      version.should eql("2.0.7")
      version = product.newest_version_number( VersionTagRecognizer::A_STABILITY_BETA )
      version.should eql("2.0.7")
      version = product.newest_version_number( VersionTagRecognizer::A_STABILITY_RC )
      version.should eql("2.0.7")
      version = product.newest_version_number( VersionTagRecognizer::A_STABILITY_STABLE )
      version.should eql("2.0.7")
    end

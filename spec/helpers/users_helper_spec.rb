...
describe UsersHelper do
  ...
  describe "has_permission_to_see_products" do 
    ...
    it "has permission. user and current_user are the same!" do 
      ...
      user.id = 1
      current_user = user
      @users_controller.has_permission_to_see_products( user, current_user ).should be_true
    end
    ...
    it "has no permission. user privacy is for nobody!" do 
      ...
      @users_controller.has_permission_to_see_products( user, current_user ).should be_false
    end
    ...
    it "has no permission. user privacy is for nobody! current_user is nil" do 
      ...
      user.id = 1
      user.privacy_products = "nobody"
      @users_controller.has_permission_to_see_products( user, nil ).should be_false
    end

Versioneye::Application.routes.draw do
  ...
  get   'sitemap-0001.xml',       :to => 'page#sitemap_1'
  get   'sitemap-0002.xml',       :to => 'page#sitemap_2'
  get   'sitemap-0003.xml',       :to => 'page#sitemap_3'
  get   'sitemap-0004.xml',       :to => 'page#sitemap_4'
  get   'sitemap-0005.xml',       :to => 'page#sitemap_5'
  get   'sitemap-0006.xml',       :to => 'page#sitemap_6'
  get   'sitemap-0007.xml',       :to => 'page#sitemap_7'
  get   'sitemap-0008.xml',       :to => 'page#sitemap_8'
  get   'sitemap-0009.xml',       :to => 'page#sitemap_9'
  get   'sitemap-0010.xml',       :to => 'page#sitemap_10'
  get   'sitemap-0011.xml',       :to => 'page#sitemap_11'
  get   'sitemap-0012.xml',       :to => 'page#sitemap_12'
  get   'sitemap-0013.xml',       :to => 'page#sitemap_13'
  get   'sitemap-0014.xml',       :to => 'page#sitemap_14'
  get   'sitemap-0015.xml',       :to => 'page#sitemap_15'
  get   'sitemap-0016.xml',       :to => 'page#sitemap_16'
  get   'sitemap-0017.xml',       :to => 'page#sitemap_17'
  get   'sitemap-0018.xml',       :to => 'page#sitemap_18'
  get   'sitemap-0019.xml',       :to => 'page#sitemap_19'
  get   'sitemap-0020.xml',       :to => 'page#sitemap_20'
  get   'sitemap-0021.xml',       :to => 'page#sitemap_21'
  get   'sitemap-0022.xml',       :to => 'page#sitemap_22'
  get   'sitemap-0023.xml',       :to => 'page#sitemap_23'
  get   'sitemap-0024.xml',       :to => 'page#sitemap_24'
  get   'sitemap-0025.xml',       :to => 'page#sitemap_25'
  get   'sitemap-0026.xml',       :to => 'page#sitemap_26'
  get   'sitemap-0027.xml',       :to => 'page#sitemap_27'
  get   'sitemap-0028.xml',       :to => 'page#sitemap_28'
  get   'sitemap-0029.xml',       :to => 'page#sitemap_29'
  get   'sitemap-0030.xml',       :to => 'page#sitemap_30'
  get   'sitemap-0031.xml',       :to => 'page#sitemap_31'
  get   'sitemap-0032.xml',       :to => 'page#sitemap_32'
  get   'sitemap-0033.xml',       :to => 'page#sitemap_33'
  get   'sitemap-0034.xml',       :to => 'page#sitemap_34'
  get   'sitemap-0035.xml',       :to => 'page#sitemap_35'
  get   'sitemap-0036.xml',       :to => 'page#sitemap_36'
  get   'sitemap-0037.xml',       :to => 'page#sitemap_37'

Versioneye::Application.routes.draw do
  ...
  get   '/package/:key/version/:version/circle_dependencies', :to => 'products#circle_dependencies'
  get   '/product/:key/version/:version/circle_dependencies', :to => 'products#circle_dependencies'

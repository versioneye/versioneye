Versioneye::Application.routes.draw do
  ...
  get   'sitemap-001.xml',       :to => 'page#sitemap_1'
  get   'sitemap-002.xml',       :to => 'page#sitemap_2'
  get   'sitemap-003.xml',       :to => 'page#sitemap_3'
  get   'sitemap-004.xml',       :to => 'page#sitemap_4'
  get   'sitemap-005.xml',       :to => 'page#sitemap_5'
  get   'sitemap-006.xml',       :to => 'page#sitemap_6'
  get   'sitemap-007.xml',       :to => 'page#sitemap_7'
  get   'sitemap-008.xml',       :to => 'page#sitemap_8'
  get   'sitemap-009.xml',       :to => 'page#sitemap_9'
  get   'sitemap-010.xml',       :to => 'page#sitemap_10'
  get   'sitemap-011.xml',       :to => 'page#sitemap_11'
  get   'sitemap-012.xml',       :to => 'page#sitemap_12'
  get   'sitemap-013.xml',       :to => 'page#sitemap_13'
  get   'sitemap-014.xml',       :to => 'page#sitemap_14'
  get   'sitemap-015.xml',       :to => 'page#sitemap_15'
  get   'sitemap-016.xml',       :to => 'page#sitemap_16'
  get   'sitemap-017.xml',       :to => 'page#sitemap_17'
  get   'sitemap-018.xml',       :to => 'page#sitemap_18'
  get   'sitemap-019.xml',       :to => 'page#sitemap_19'
  get   'sitemap-020.xml',       :to => 'page#sitemap_20'
  get   'sitemap-021.xml',       :to => 'page#sitemap_21'
  get   'sitemap-022.xml',       :to => 'page#sitemap_22'
  get   'sitemap-023.xml',       :to => 'page#sitemap_23'
  get   'sitemap-024.xml',       :to => 'page#sitemap_24'
  get   'sitemap-025.xml',       :to => 'page#sitemap_25'
  get   'sitemap-026.xml',       :to => 'page#sitemap_26'

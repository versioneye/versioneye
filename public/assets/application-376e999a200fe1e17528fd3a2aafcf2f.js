...
function follow(product_name, product_key){
	alert("follow");
	$.ajax({
	  'POST',
	  "/products/follow_signed.text",
	  {key : product_key},
	  follow_success_message(data, product_name),
	  "xml"
	});
}

function follow_success_message(data, product_name){
	alert("You are following now " + product_name)
}

 ...
 */
"use strict";function n(e){return"SELECT"===e.nodeName||"INPUT"===e.nodeName&&"file"===e.type}function o(e){var t=M.getPooled(w.change,T,e);C.accumulateTwoPhaseDispatches(t),E.batchedUpdates(r,t)}function r(e){y.enqueueEvents(e),y.processEventQueue()}function a(e,t){I=e,T=t,I.attachEvent("onchange",o)}function i(){I&&(I.detachEvent("onchange",o),I=null,T=null)}function s(e,t,n){return e===D.topChange?n:void 0}function u(e,t,n){e===D.topFocus?(i(),a(t,n)):e===D.topBlur&&i()}function c(e,t){I=e,T=t,P=e.value,O=Object.getOwnPropertyDescriptor(e.constructor.prototype,"value"),Object.defineProperty(I,"value",k),I.attachEvent("onpropertychange",p)}function l(){I&&(delete I.value,I.detachEvent("onpropertychange",p),I=null,T=null,P=null,O=null)}function p(e){if("value"===e.propertyName){var t=e.srcElement.value;t!==P&&(P=t,o(e))}}function d(e,t,n){return e===D.topInput?n:void 0}function h(e,t,n){e===D.topFocus?(l(),c(t,n)):e===D.topBlur&&l()}function m(e){return e!==D.topSelectionChange&&e!==D.topKeyUp&&e!==D.topKeyDown||!I||I.value===P?void 0:(P=I.value,T)}function f(e){return"INPUT"===e.nodeName&&("checkbox"===e.type||"radio"===e.type)}function v(e,t,n){return e===D.topClick?n:void 0}var g=e("./EventConstants"),y=e("./EventPluginHub"),C=e("./EventPropagators"),R=e("./ExecutionEnvironment"),E=e("./ReactUpdates"),M=e("./SyntheticEvent"),b=e("./isEventSupported"),x=e("./isTextInputElement"),_=e("./keyOf"),D=g.topLevelTypes,w={change:{phasedRegistrationNames:{bubbled:_({onChange:null}),captured:_({onChangeCapture:null})},dependencies:[D.topBlur,D.topChange,D.topClick,D.topFocus,D.topInput,D.topKeyDown,D.topKeyUp,D.topSelectionChange]}},I=null,T=null,P=null,O=null,N=!1;R.canUseDOM&&(N=b("change")&&(!("documentMode"in document)||document.documentMode>8));var S=!1;R.canUseDOM&&(S=b("input")&&(!("documentMode"in document)||document.documentMode>9));var k={get:function(){return O.get.call(this)},set:function(e){P=""+e,O.set.call(this,e)}},A={eventTypes:w,extractEvents:function(e,t,o,r){var a,i;if(n(t)?N?a=s:i=u:x(t)?S?a=d:(a=m,i=h):f(t)&&(a=v),a){var c=a(e,t,o);if(c){var l=M.getPooled(w.change,c,r);return C.accumulateTwoPhaseDispatches(l),l}}i&&i(e,t,o)}};t.exports=A},{"./EventConstants":14,"./EventPluginHub":16,"./EventPropagators":19,"./ExecutionEnvironment":20,"./ReactUpdates":71,"./SyntheticEvent":78,"./isEventSupported":113,"./isTextInputElement":115,"./keyOf":119}],5:[function(e,t){/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */
"use strict";function n(){o.EventEmitter.injectTopLevelCallbackCreator(m),o.EventPluginHub.injectEventPluginOrder(c),o.EventPluginHub.injectInstanceHandle(b),o.EventPluginHub.injectMount(x),o.EventPluginHub.injectEventPluginsByName({SimpleEventPlugin:w,EnterLeaveEventPlugin:l,ChangeEventPlugin:i,CompositionEventPlugin:u,MobileSafariClickEventPlugin:p,SelectEventPlugin:_}),o.DOM.injectComponentClasses({button:v,form:g,img:y,input:C,option:R,select:E,textarea:M,html:T(f.html),head:T(f.head),title:T(f.title),body:T(f.body)}),o.CompositeComponent.injectMixin(d),o.DOMProperty.injectDOMPropertyConfig(a),o.Updates.injectBatchingStrategy(I),o.RootIndex.injectCreateReactRootIndex(r.canUseDOM?s.createReactRootIndex:D.createReactRootIndex),o.Component.injectEnvironment(h);var t=r.canUseDOM&&window.location.href||"";if(/[?&]react_perf\b/.test(t)){var n=e("./ReactDefaultPerf");n.start()}}var o=e("./ReactInjection"),r=e("./ExecutionEnvironment"),a=e("./DefaultDOMPropertyConfig"),i=e("./ChangeEventPlugin"),s=e("./ClientReactRootIndex"),u=e("./CompositionEventPlugin"),c=e("./DefaultEventPluginOrder"),l=e("./EnterLeaveEventPlugin"),p=e("./MobileSafariClickEventPlugin"),d=e("./ReactBrowserComponentMixin"),h=e("./ReactComponentBrowserEnvironment"),m=e("./ReactEventTopLevelCallback"),f=e("./ReactDOM"),v=e("./ReactDOMButton"),g=e("./ReactDOMForm"),y=e("./ReactDOMImg"),C=e("./ReactDOMInput"),R=e("./ReactDOMOption"),E=e("./ReactDOMSelect"),M=e("./ReactDOMTextarea"),b=e("./ReactInstanceHandles"),x=e("./ReactMount"),_=e("./SelectEventPlugin"),D=e("./ServerReactRootIndex"),w=e("./SimpleEventPlugin"),I=e("./ReactDefaultBatchingStrategy"),T=e("./createFullPageComponent");t.exports={inject:n}},{"./ChangeEventPlugin":4,"./ClientReactRootIndex":5,"./CompositionEventPlugin":6,"./DefaultDOMPropertyConfig":11,"./DefaultEventPluginOrder":12,"./EnterLeaveEventPlugin":13,"./ExecutionEnvironment":20,"./MobileSafariClickEventPlugin":22,"./ReactBrowserComponentMixin":25,"./ReactComponentBrowserEnvironment":28,"./ReactDOM":32,"./ReactDOMButton":33,"./ReactDOMForm":35,"./ReactDOMImg":37,"./ReactDOMInput":38,"./ReactDOMOption":39,"./ReactDOMSelect":40,"./ReactDOMTextarea":42,"./ReactDefaultBatchingStrategy":43,"./ReactDefaultPerf":45,"./ReactEventTopLevelCallback":50,"./ReactInjection":51,"./ReactInstanceHandles":53,"./ReactMount":55,"./SelectEventPlugin":72,"./ServerReactRootIndex":73,"./SimpleEventPlugin":74,"./createFullPageComponent":92}],45:[function(e,t){/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */
"use strict";function n(e){var t=v(e);return t&&P.getID(t)}function o(e){var t=r(e);if(t)if(M.hasOwnProperty(t)){var n=M[t];n!==e&&(y(!s(n,t),"ReactMount: Two valid but unequal nodes with the same `%s`: %s",E,t),M[t]=e)}else M[t]=e;return t}function r(e){return e&&e.getAttribute&&e.getAttribute(E)||""}function a(e,t){var n=r(e);n!==t&&delete M[n],e.setAttribute(E,t),M[t]=e}function i(e){return M.hasOwnProperty(e)&&s(M[e],e)||(M[e]=P.findReactNodeByID(e)),M[e]}function s(e,t){if(e){y(r(e)===t,"ReactMount: Unexpected modification of `%s`",E);var n=P.findReactContainerForID(t);if(n&&f(n,e))return!0}return!1}function u(e){delete M[e]}function c(e){var t=M[e];return t&&s(t,e)?void(T=t):!1}function l(e){T=null,h.traverseAncestors(e,c);var t=T;return T=null,t}var p=e("./DOMProperty"),d=e("./ReactEventEmitter"),h=e("./ReactInstanceHandles"),m=e("./ReactPerf"),f=e("./containsNode"),v=e("./getReactRootElementInContainer"),g=e("./instantiateReactComponent"),y=e("./invariant"),C=e("./shouldUpdateReactComponent"),R=h.SEPARATOR,E=p.ID_ATTRIBUTE_NAME,M={},b=1,x=9,_={},D={},w={},I=[],T=null,P={totalInstantiationTime:0,totalInjectionTime:0,useTouchEvents:!1,_instancesByReactRootID:_,scrollMonitor:function(e,t){t()},_updateRootComponent:function(e,t,o,r){var a=t.props;return P.scrollMonitor(o,function(){e.replaceProps(a,r)}),w[n(o)]=v(o),e},_registerComponent:function(e,t){y(t&&(t.nodeType===b||t.nodeType===x),"_registerComponent(...): Target container is not a DOM element."),d.ensureScrollValueMonitoring();var n=P.registerContainer(t);return _[n]=e,n},_renderNewRootComponent:m.measure("ReactMount","_renderNewRootComponent",function(e,t,n){var o=g(e),r=P._registerComponent(o,t);return o.mountComponentIntoNode(r,t,n),w[r]=v(t),o}),renderComponent:function(e,t,o){var r=_[n(t)];if(r){if(C(r,e))return P._updateRootComponent(r,e,t,o);P.unmountComponentAtNode(t)}var a=v(t),i=a&&P.isRenderedByReact(a),s=i&&!r,u=P._renderNewRootComponent(e,t,s);return o&&o.call(u),u},constructAndRenderComponent:function(e,t,n){return P.renderComponent(e(t),n)},constructAndRenderComponentByID:function(e,t,n){var o=document.getElementById(n);return y(o,'Tried to get element with id of "%s" but it is not present on the page.',n),P.constructAndRenderComponent(e,t,o)},registerContainer:function(e){var t=n(e);return t&&(t=h.getReactRootIDFromNodeID(t)),t||(t=h.createReactRootID()),D[t]=e,t},unmountComponentAtNode:function(e){var t=n(e),o=_[t];return o?(P.unmountComponentFromNode(o,e),delete _[t],delete D[t],delete w[t],!0):!1},unmountComponentFromNode:function(e,t){for(e.unmountComponent(),t.nodeType===x&&(t=t.documentElement);t.lastChild;)t.removeChild(t.lastChild)},findReactContainerForID:function(e){var t=h.getReactRootIDFromNodeID(e),n=D[t],o=w[t];if(o&&o.parentNode!==n){y(r(o)===t,"ReactMount: Root element ID differed from reactRootID.");var a=n.firstChild;a&&t===r(a)?w[t]=a:console.warn("ReactMount: Root element has been removed from its original container. New container:",o.parentNode)}return n},findReactNodeByID:function(e){var t=P.findReactContainerForID(e);return P.findComponentRoot(t,e)},isRenderedByReact:function(e){if(1!==e.nodeType)return!1;var t=P.getID(e);return t?t.charAt(0)===R:!1},getFirstReactDOM:function(e){for(var t=e;t&&t.parentNode!==t;){if(P.isRenderedByReact(t))return t;t=t.parentNode}return null},findComponentRoot:function(e,t){var n=I,o=0,r=l(t)||e;for(n[0]=r.firstChild,n.length=1;o<n.length;){for(var a,i=n[o++];i;){var s=P.getID(i);s?t===s?a=i:h.isAncestorIDOf(s,t)&&(n.length=o=0,n.push(i.firstChild)):n.push(i.firstChild),i=i.nextSibling}if(a)return n.length=0,a}n.length=0,y(!1,"findComponentRoot(..., %s): Unable to find element. This probably means the DOM was unexpectedly mutated (e.g., by the browser), usually due to forgetting a <tbody> when using tables or nesting <p> or <a> tags. Try inspecting the child nodes of the element with React ID `%s`.",t,P.getID(e))},getReactRootID:n,getID:o,setID:a,getNode:i,purgeID:u};t.exports=P},{"./DOMProperty":8,"./ReactEventEmitter":48,"./ReactInstanceHandles":53,"./ReactPerf":60,"./containsNode":89,"./getReactRootElementInContainer":107,"./instantiateReactComponent":111,"./invariant":112,"./shouldUpdateReactComponent":131}],56:[function(e,t){/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.

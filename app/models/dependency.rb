class Dependency
  ...
  field :dep_prod_key, type: String   # prod_key of the dependency (Foreign Key) # TODO_vc
  field :scope       , type: String   # scope of the dependency

  field :prod_key    , type: String   # This dependency belongs to this prod_key  # TODO_vc
